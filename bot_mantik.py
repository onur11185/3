...
def commands():
    commandss = [
        "?hello: Geri Selam Verir",
        "?smile: Emoji yollar",
        "?coin: Yazı Tura atar",
        "?number: 1-10 arası rastgele sayı seçer",
        "?pass: rastgele bir şifre oluşturur",
        "?bye: 'Görüşürüz' Yazar",
        "?facts: Bazı gerçekleri rastgele bir şekilde söyler",
        "?8ball: komudu yazdıktan sonra sorduğun soruya karşılık rastgele cevap verir"
    ]  
    return random.choice(commandss[0])  